 ...
 * TurnExecutorPlanner behind named static methods.
 *
 * Scope (JIRA-195 Slice 2, JIRA-214 P2):
 *   - adviseBuild: wraps BuildAdvisor.advise + BuildAdvisor.retryWithSolvencyFeedback
 *     (Phase B build path)
 *
 * Note: adviseEnrichment was removed by JIRA-214 P2. Route enrichment now fires
 * exclusively from MovementPhasePlanner's Phase A stop-execution loop.
 */
