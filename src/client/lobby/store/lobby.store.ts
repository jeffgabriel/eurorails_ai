...
interface LobbyActions {
  ...
  // Bot management
  addBot: (gameId: ID, config: { skillLevel: string; name?: string; provider?: string; model?: string; color?: string }) => Promise<void>;
...
export const useLobbyStore = create<LobbyStore>((set, get) => ({
  ...
  addBot: async (_gameId: ID, config: { skillLevel: string; name?: string; provider?: string; model?: string; color?: string }) => {
